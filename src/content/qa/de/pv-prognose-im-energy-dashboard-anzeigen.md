...
1. **Prognose-Integration installieren:** HACS → Integrationen → „Volcast" suchen (oder das Repo von volter-labs hinzufügen) → HA neu starten → Integration einrichten und die Anlagenkonfiguration aus der App übernehmen.
...
3. **Nach einem Tag prüfen:** Auf der Produktionskurve erscheint die gestrichelte Prognoselinie; die Zahlen-Entitäten (Energie heute/morgen, Peak-Stunde) kannst du zusätzlich auf ein eigenes Dashboard legen oder in Automationen nutzen.
